--*******************************************************
--Book "PostgreSQL 9.0 High Performance" by Gregory Smith
--*******************************************************
...
(SELECT 
 ...
 round(current_setting('autovacuum_vacuum_threshold')::integer + current_setting('autovacuum_vacuum_scale_factor')::numeric * C.reltuples)
